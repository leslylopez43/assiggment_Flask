...
cur.execute('''CREATE TABLE IF NOT EXISTS vehicles(VehiclesID serial PRIMARY KEY, Registration_number varchar(100), Brand varchar(100), Model varchar(100), Color varchar(100), Price varchar(100), Car_year varchar(100), On_stock_From varchar (100), Available varchar(100);''')
