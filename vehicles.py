...
cur.execute('''INSERT INTO vehicles(registration_number, brand, model, color, price_name, car_year, on_stock_from, available) VALUES ('bre12wef','Mercedes', 'Benz', 'white', '£10233','2023', '20/02/2033', 'yes';''') # imperial@imperial.com, 40 Bounder roar unit 5 N15 9HI, London),('supplier',6000,30);''')
