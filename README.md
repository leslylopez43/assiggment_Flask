...
| Frontpage Wireframe              | Screenshot 2                |
| --------------------------  | --------------------------  |
| ![Frontpage Wireframe](/static/img/Wireframe.webp) | ![Wireframe](screenshot2.png) |

| Wireframe                | Wireframe                |
| --------------------------  | --------------------------  |
| ![Wireframe](screenshot3.png) | ![Wireframe](screenshot4.png) |
